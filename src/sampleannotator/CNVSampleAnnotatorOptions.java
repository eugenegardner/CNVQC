...
public class CNVSampleAnnotatorOptions {
	...
	private Options setOptions() {
		...
		optionsList.add(new Option("q", true, "Path to Summary_stats.dat bulk qcsum file."));
