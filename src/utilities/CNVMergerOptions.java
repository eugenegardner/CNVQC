...
public class CNVMergerOptions {
	...
	private Options setOptions() {
		...
		optionsList.add(new Option("e", true, "Epsilon to run dbscan at."));
		...
		options.addOption(new Option("f", false, "Filter based on RandomForest model?"));
